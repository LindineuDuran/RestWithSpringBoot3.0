...
public class PersonControllerJsonTest extends AbstractIntegrationTest
{
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException
	{
		...
		{
			assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1/674\"}}}"));
			assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1/406\"}}}"));
			assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1/794\"}}}"));

			assertTrue(content.contains("first\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1?direction=asc&page=0&size=10&sort=firstName,asc\"}"));
			assertTrue(content.contains("prev\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1?direction=asc&page=2&size=10&sort=firstName,asc\"}"));
			assertTrue(content.contains("self\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1?page=3&size=10&direction=asc\"}"));
			assertTrue(content.contains("next\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1?direction=asc&page=4&size=10&sort=firstName,asc\"}"));
			assertTrue(content.contains("last\":{\"href\":\"http://localhost:" + TestConfigs.SERVER_PORT+ "/api/person/v1?direction=asc&page=100&size=10&sort=firstName,asc\"}"));
		}
		else
		{
			assertTrue(content.contains("_links\":{\"self\":{\"href\":\"http://localhost/api/person/v1/674\"}}}"));
