...
public class BookControllerYamlTest extends AbstractIntegrationTest
{
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException
	{
		...
		{
			assertTrue(content.contains("rel: \"self\"\n" + "    href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1/12\""));
			assertTrue(content.contains("rel: \"self\"\n" + "    href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1/8\""));
			assertTrue(content.contains("rel: \"self\"\n" + "    href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1/15\""));

			assertTrue(content.contains("rel: \"first\"\n" + "  href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1?direction=asc&page=0&size=10&sort=title,asc\""));
			assertTrue(content.contains("rel: \"self\"\n" + "  href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1?page=0&size=10&direction=asc\""));
			assertTrue(content.contains("rel: \"next\"\n" + "  href: \"http://localhost:" + TestConfigs.SERVER_PORT + "/api/book/v1?direction=asc&page=1&size=10&sort=title,asc\""));
